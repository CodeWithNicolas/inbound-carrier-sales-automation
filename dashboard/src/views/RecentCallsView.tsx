                ...
                {calls.slice(0, 25).map((c, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={tdStyle}>
                        {c.initial_rate != null && !isNaN(parseFloat(c.initial_rate)) ? `$${parseFloat(c.initial_rate).toFixed(0)}` : '—'}{' '}
                        →{' '}
                        {c.final_rate != null && !isNaN(parseFloat(c.final_rate)) ? `$${parseFloat(c.final_rate).toFixed(0)}` : '—'}
                      </td>
